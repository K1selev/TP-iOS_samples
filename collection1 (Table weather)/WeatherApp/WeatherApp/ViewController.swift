...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        models = [
            CellModel(title: "Moscow", temp: "5˚C", time: "19:30"),
            CellModel(title: "Dubai", temp: "25˚C", time: "20:30"),
            CellModel(title: "Kotelniki", temp: "7˚C", time: "20:30")
        ]
        
        models = Array(repeating: CellModel(title: "Moscow", temp: "5˚C", time: "19:30"), count: 100)
    }
    
    private func addCity(with title: String) {
        let model = CellModel(title: title, temp: "5˚C", time: "19:30")
        models.append(model)
        tableView.beginUpdates()
        tableView.insertRows(at: [IndexPath(row: self.models.count - 1, section: 0)], with: .left)
