...
final class StoriesCell: UICollectionViewCell {
    ...
    private var models: [StoryCellModel] = []
    ...
    func configure(with models: [StoryCellModel]) {
        self.models = models
    }
}
...
extension StoriesCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.row == 0 {
            ...
            cell.configure(with: StoryCellModel(image: UIImage(systemName: "photo.circle"), isViewed: true))
